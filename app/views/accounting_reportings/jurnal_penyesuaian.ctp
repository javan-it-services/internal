<div class="accountingAccounts index page">
	...
	<div id="column_right" class="grid_13 omega">
		...
		<!-- START FILTER -->
		<?php echo $form->create('FilterJurnalPenyesuaian',array('url' => '/accounting_reportings/jurnal_penyesuaian')); ?>
		
		<table cellpadding="0" cellspacing="0">
			<tr>
				<th>From</th><td><?php echo $form->dateTime('FilterJurnalPenyesuaian.created_from','YMD','NONE',$jurnal_selected_from,null,false); ?></td>
				<td width="50">&nbsp;</td>
				<th>To</th><td><?php echo $form->dateTime('FilterJurnalPenyesuaian.created_to','YMD','NONE',$jurnal_selected_to,null,false); ?></td>
				<th>
