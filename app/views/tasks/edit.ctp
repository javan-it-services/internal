    ...
    <fieldset>
            <ol>
                <li>
                    ...
                    <input name="data[Task][name]" type="text" id="TaskName" value="<?php echo $this->data['Task']['name'] ?>" />
                    <p class="helper"><?php __("Short name, easy remembered title", false) ?></p>
                </li>
                <li>
                    <label for="TaskDescription"><?php __("Description", false) ?></label>
                    <textarea name="data[Task][description]" id="TaskDescription" class="expand"><?php echo $this->data['Task']['description'] ?></textarea>
                ...
                <li class="separator"></li>
                <li>
                    <?php echo $form->input('user_id', array("label"=>"Assign to", "empty"=>"--Choose One--")); ?>
                </li>
                <li>
                    <?php
                    if(isset($project_id)){
                ...
                <li class="message highlight">
                   ...
                   <div id="attachments">
                        <?php foreach($this->data['Document'] as $doc):?>
