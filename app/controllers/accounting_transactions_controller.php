<?php
class AccountingTransactionsController extends AppController {

	var $name = 'AccountingTransactions';
	var $helpers = array('Html', 'Form', 'Number');
	
	function __construct() {
		parent::__construct();
		$this->set("modul","accounting");
		$this->set("submodul","transaction");
	...
	function _filter()
	{
		...
		$this->paginate['conditions']['AccountingTransaction.adjustment'] = false;
		$this->paginate['order'] = 'AccountingTransaction.created DESC';
